com_company_knkx_web_tailieu_BanAn_InputEdit2  = function () {
      var connector = this;
        var element = connector.getElement();
        element.innerHTML = '<iframe allowfullscreen webkitallowfullscreen height="100%" width="100%" id="resultFrame2" src="VAADIN/pdfjsdist/web/viewer.html?inputid=hdfIframeFileContent2" style="width: 100%;height:100%;"></iframe><input type="hidden" id="hdfIframeFileContent2" value="" />';


        connector.onStateChange = function () {
            var state = connector.getState();

            var iframeWindow = document.getElementById("resultFrame2").contentWindow;
            if(typeof(state.data.options) != "undefined") {
                var src = document.getElementById("resultFrame2").src;
                ...
                document.getElementById("resultFrame2").src = src;
            }
            ...
            this.loadResourceFileViaBase64 = function(base64Encode) {
                var hiddenContent = document.getElementById("hdfIframeFileContent2");
